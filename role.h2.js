/**
 * roleh2: A remote harvester that mines in a target room and deposits into a specific container.
 * - Travels to a designated mining room ('W29S15').
 * - Harvests from a specific source position.
 * - Returns to the home room ('W29S14').
 * - Deposits all energy into the first available container by priority.
 */
var roleh2 = {
    ...
    run: function(creep) {
        ...
        if (creep.memory.harvesting) {
            // --- GO TO MINING ROOM ---
            const targetRoomName = 'W29S15'; // <-- SET THIS
            const targetPos = new RoomPosition(14, 46, targetRoomName);
