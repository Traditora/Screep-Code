/**
 * roleh3: A remote harvester that mines in a target room and deposits into a specific container.
 * - Travels to a designated mining room ('W29S16').
...
var roleh3 = {
    ...
    run: function(creep) {
        ...
        if (creep.memory.harvesting) {
            // --- GO TO MINING ROOM ---
            const targetRoomName = 'W29S16'; // <-- SET THIS
            const targetPos = new RoomPosition(16, 43, targetRoomName);
